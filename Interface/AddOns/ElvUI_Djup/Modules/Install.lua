...
local function ElvSettings()
	...
	do
		...
		if IsAddOnLoaded("ElvUI_SLE") and IsAddOnLoaded("ElvUI_CustomTweaks") then
			...
			E.db["movers"]["BuffsMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-196,-10"
			...
			E.db["movers"]["ElvUF_Raid40Mover"] = "TOPLEFT,ElvUIParent,BOTTOMLEFT,812,186"
			...
			E.db["movers"]["ArenaHeaderMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-4,-260"
			...
			E.db["movers"]["ElvUF_PetMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,530,220"
			...
			E.db["movers"]["DebuffsMover"] = "TOPRIGHT,ElvUIParent,TOPRIGHT,-196,-161"
			...
			E.db["unitframe"]["units"]["raid40"]["numGroups"] = 4
			...
			E.db["unitframe"]["units"]["raid40"]["width"] = 60
			E.db["unitframe"]["units"]["raid40"]["name"]["text_format"] = "[name:theshortest]"
			E.db["unitframe"]["units"]["raid40"]["name"]["position"] = "BOTTOMRIGHT"
